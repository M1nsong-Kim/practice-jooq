...
public class Color extends TableImpl<ColorRecord> {
     ...
     */
    public final TableField<ColorRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>jooq.color.color_name</code>.
     */
    public final TableField<ColorRecord, String> COLOR_NAME = createField(DSL.name("color_name"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>jooq.color.product_id</code>.
     */
    public final TableField<ColorRecord, String> PRODUCT_ID = createField(DSL.name("product_id"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");
