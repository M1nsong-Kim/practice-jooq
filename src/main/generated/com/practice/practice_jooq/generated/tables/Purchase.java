...
public class Purchase extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Integer> PURCHASE_ID = createField(DSL.name("purchase_id"), SQLDataType.INTEGER.defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.INTEGER)), this, "");
     ...
     */
    public final TableField<Record, String> MEMBER_ID = createField(DSL.name("member_id"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<Record, String> REGISTER = createField(DSL.name("register"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>jooq.purchase.updater</code>.
     */
    public final TableField<Record, String> UPDATER = createField(DSL.name("updater"), SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>jooq.purchase.status</code>.
     */
    public final TableField<Record, PurchaseStatus> STATUS = createField(DSL.name("status"), SQLDataType.VARCHAR(9).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)).asEnumDataType(com.practice.practice_jooq.generated.enums.PurchaseStatus.class), this, "");

    private Purchase(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private Purchase(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> Purchase(Table<O> child, ForeignKey<O, Record> key) {
